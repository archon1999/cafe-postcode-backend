...
class CoreSettings(Settings):
    ...
    MANAGEMENT_BOT_TOKEN = os.getenv('MANAGEMENT_BOT_TOKEN', '').strip()
    MANAGEMENT_BOT_USERNAME = os.getenv('MANAGEMENT_BOT_USERNAME', '').strip().lstrip('@')
    MANAGEMENT_BOT_WEBHOOK_SECRET = os.getenv('MANAGEMENT_BOT_WEBHOOK_SECRET', '').strip()
