...
def extract_menu(content, categories):
    ...
    instructions = (
        ...
        'This catalog always uses Uzbek som (UZS). Treat all menu prices as UZS, even without a currency label. '
        'Convert explicit ming/k amounts to whole UZS; never perform currency conversion. '
        'Use the explicit sale unit when present; otherwise default to piece. '
        'Do not warn about omitted currency or sale unit, and do not restate a clearly read price in warning. '
        'Warnings are only for actionable ambiguities or unreadable source data. '
