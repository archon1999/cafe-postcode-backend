...
class AdminOrderItemNoteSerializer(serializers.ModelSerializer):
    restaurant_name = serializers.CharField(
        source="order_item.order.restaurant.name", read_only=True
    )
    ...
    catalog_item_name = serializers.CharField(
        source="order_item.catalog_item.name", read_only=True
    )
    table_name = serializers.CharField(
        source="order_item.order.table_session.table.name", read_only=True
    )
