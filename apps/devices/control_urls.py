...
from apps.devices.control_views import (
    ...
    ControlTelegramSubscriptionRevokeView,
)
...
urlpatterns = [
    ...
    path(
        'branches/<uuid:restaurant_id>/telegram-subscriptions/<uuid:subscription_id>/revoke/',
        ControlTelegramSubscriptionRevokeView.as_view(),
    ),
    path(
