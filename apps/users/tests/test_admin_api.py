...
from apps.platform.services.faktura import FakturaError
...
class AdminApiTests(APITestCase):
    ...
    def setUpTestData(cls):
        ...
        cls.tariff.allowed_roles.set([cls.admin_role])
    ...
    def test_admin_routes_resolve_to_admin_views(self):
        ...
        self.assertEqual(match.func.view_class.__module__, 'apps.users.api.admin.views.auth')

        match = resolve('/api/v1/admin/reporting/summary/')
        self.assertEqual(match.func.view_class.__module__, 'apps.reporting.api.admin.views.reports')
    ...
    def test_admin_users_roles_and_permissions_endpoints(self):
        ...
        permission_options_response = self.client.get('/api/v1/admin/permissions/options/')
    ...
    def test_restaurant_update_can_bind_tariff_capability(self):
        ...
        response = self.client.patch(
            f'/api/v1/admin/restaurants/{self.restaurant.id}/',
            {'tariffId': str(self.tariff.id)},
            format='json',
        )
    ...
    def test_admin_catalog_items_support_active_filter(self):
        self.authenticate()
    ...
    @patch('apps.platform.api.admin.views.business_partners.FakturaClient.lookup_company_basic_details')
