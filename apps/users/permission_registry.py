...
PERMISSION_DEFINITIONS = [
    ...
    permission_definition(
        ...
        endpoints=endpoint_specs(
            ...
            ('POST', 'api/v1/pos/floor/table-sessions/<uuid:pk>/transfer/'),
            ('POST', 'api/v1/pos/floor/table-sessions/<uuid:pk>/group/'),
            ('POST', 'api/v1/pos/floor/table-sessions/<uuid:pk>/ungroup/'),
