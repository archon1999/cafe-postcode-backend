...
from apps.admin.serializers.users import PermissionOptionSerializer, RoleSerializer
from apps.admin.support.business_partner import ACTIVATION_EXCLUDED_ROLE_CODES
